...
5. Copy everything from the live repo except for the ".git" folder and "docs" folder. The ".git" folder may not be visible, but you can find the content by typing it in directly, i.e. "...\PIP-Methodology-YYYY-MM\.git\"
