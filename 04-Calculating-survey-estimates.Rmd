...
Armed with welfare distributions expressed in 2021 PPPs and an international poverty line, poverty and inequality can be calculated and compared across countries and over time. The poverty and inequality measures used in the Poverty and Equity Platform (PIP) are mainly based on a formula in @haughton2009. In the formulas below we abstract from household weights for simplicity.
...
The prosperity gap (PG) is the average factor by which incomes fall short of a prosperity standard of \$28 per person per day (expressed in 2021 PPP dollars) (@kraay2023 and @jolliffe2025). It is given by:
