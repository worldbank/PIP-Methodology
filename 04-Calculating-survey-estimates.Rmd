...
[Grouped data](#grouped) often have fewer than 100 observations, in which case the percentiles for grouped data are based on [a parametric fit of the Lorenz curve](#tgd). The percentiles are based on the Lorenz curve used for distributional statistics (like the decile shares, Gini coefficient, and median) in the PIP output. 
