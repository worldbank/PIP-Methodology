...
In the majority of cases, the surveys used are representative at the national level of all households in a country. Often, the selection of households is based on the most recent census. Yet three factors often prevent surveys from being representative of the entire population:
...
All of the data are going through validity checks by the Poverty and Equity Global Practice of the World Bank. In certain occasions, the Poverty and Equity GLobal Practicie is also responsible for harmonizing and constructing the welfare aggreagates. The harmonized welfare aggregates are passed on to the Poverty and Inequality Platform.
