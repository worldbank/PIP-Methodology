...
For the purpose of calculating global or regional poverty, the poverty rates estimated in the surveys are assumed to be representative of the entire population despite the three shortcomings above. This is largely because acquiring any alternative poverty estimate for the missing populations is challenging.

PIP also contains some surveys which explicitly only target the urban or rural part of the population. These surveys are not used for the purposes of calculating regional or global poverty, except in Argentina, which only has surveys representative of their urban population. In Argentina, for the purposes of calculating regional and global poverty rates, the urban poverty rate is applied as a national poverty rate.
