...
In the Poverty and Inequality platform, surveys are assigned to a particular year using two variables *year* and *datayear*. If all fieldwork took place during one calendar year, and relate to the consumption or income of that year, *year* and *datayear* are both equal to this calendar year. When household surveys span two calendar years, the *datayear* noted in the Poverty and Inequality Platform is not an integer. The Gambia, for example, has a survey listed at 2015.31. This means that 69% of the fieldwork fall in 2015 while 31% of the fieldwork months fall in 2016. In these cases, the *year* information is the floor of *datayear.* The *datayear* is used for [intrapolations](#intrapolation) , [extrapolation](#extrapolation), and at times, for the [inflation](#CPIs) to convert the welfare vector to constant prices. Notice that in some cases neither the *datayear* nor the *year* align with the year of the survey. For EU-SILC surveys, for example, the income information asked in the survey in year *t* relates to year *t-1.* Here, the *datayear* and *year* will both be one year prior to the year the survey was carried out.

## Representativeness {#representativeness}

In the majority of cases, the surveys used are representative of all households in a country. This means that they are based on a random selection of all households in the country, typically defined from the most recent census. Three factors prevent these surveys from being representative of the entire population:

1.  Some households are less likely to agree to participate in national surveys on income and consumption, or, if they participate, less likely to answer the questions used for calculating poverty. This is particularly a concern for wealthy households, which means that the distributions captured here might have too thin a tail at the top.
...
The PIP also contains some surveys which explicitly only target the urban or rural part of the population. These surveys are indicated as [waiting to see how they will appear in PIP]. These surveys are not used for the purposes of calculating regional or global poverty, with one exception. This exception concerns Argentina which has no nationally representative surveys, but only surveys representative of its urban population. For the urban population of Argentina, these surveys are used for the regional and global poverty counts, while the rural population of Argentina gets the same treatment as [countries for which we have no data](#nodata).
