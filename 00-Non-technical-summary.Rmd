...
This page summarizes the methodology in non-technical terms using five
steps. The summary is followed by five chapters that dig into these
steps in detail.
...
cannot be obtained in which case, as second best, [aggregated](#grouped)
...
are included](#imputedrent) in the welfare aggregate, and whether [price
differences within a country](#spatialtemporal) are accounted for, imply
...
data](#nodata) at all, welfare distributions are predicted from a
handful of variables. To ensure the quality of the regional and global
numbers, [coverage rules](#coverage) are used to determine whether a
particular reference year has sufficient nearby survey data for global
and regional numbers to be presented.
