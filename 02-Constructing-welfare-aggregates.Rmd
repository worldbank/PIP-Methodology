...
All poverty and inequality indicators in PIP are calculated using income and consumption distributions that drop negative incomes and replace all observations below $\$0.25$ per person per day with $\$0.25$ per person per day [@yonzanF].
...
After selecting the best approach (either GQ or Beta) for each set of group data, a synthetic welfare vector is generated, and it is treated as any unit-record data for poverty and inequality estimation.
