...
in the the [Poverty and Inequality
Platform](https://pip.worldbank.org/home) (PIP). This particular page
summarizes the methodology in non-technical terms using five steps. The
summary is followed by five chapters that dig into these steps in
detail.
